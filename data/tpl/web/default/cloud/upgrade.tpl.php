...
<div class="upgrade-content" id="js-cloud-upgrade" ng-controller="CloudUpgradeCtrl" ng-cloak>
		...
		<div class="upgrade-info we7-padding-bottom">
			<div class="panel we7-panel">
				<div class="panel-heading we7-padding ">
					...
					<span class="col-sm-7 we7-padding-none">官方 {{upgrade.family}}{{upgrade.version}}【{{upgrade.release}}】版</span>
				</div>
	...
	<div class="upgrade-wechat">
		<img src="../web/resource/images/logo/qun.png" alt="">
		<div class="info">
			<p class="title">更新说明请扫描上方二维码或"<span class="color-default"><a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=cafc93012e6d52f0e0e2cd1bd66f40f289e7e172d4567e6c408d9622847b0190">点击加群</a></span>"查看</p>
			<p class="">赶快扫码加入吧</p>
		</div>
	</div>
